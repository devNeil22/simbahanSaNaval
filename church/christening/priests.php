...
<body>
    <div class="container-fluid">
        ...
        <div class="activities1">
            <div class="title"><center><h3>Christening Mass Reservation</h3></center></div>
            <center><h4><span>Step 1: </span> Please Choose a Priest</h4></center>
            <div class="flex">
               ...
               <?php
                ...
                while($data = mysqli_fetch_assoc($exe)){ ?>
                    <div id="priests">
                        <a href="./book.php?id=<?=$data['priest_id']?>&title=Christening Reservation"><img src="../files/<?=$data['profile_pic']?>" alt="" class="rounded"></a>
                        <center><strong><?=$data['PLast_name']?> <?=$data['PFirst_Name']?></strong></center>
