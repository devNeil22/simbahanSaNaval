    ...
    <div class="container-fluid">
        ...
        <div class="activities1">
            ...
            <div class="form1">    
                ...
                <p>Please wait 2-3 working hours for a response of our personel</p>
                <p>It is compulsory to pay before we approved your reservation appointment</p>
                <p>Make sure you pay the corresponding payment using our GCASH account in transaction page!</p>
                <p>Thank you and more power!</p>
                <p>Your transaction has been recorded!</p>
                <a href="./transactions.php">See booking transaction>>></a>
            </div>
        </div>
