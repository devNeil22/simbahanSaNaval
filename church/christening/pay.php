...
<body>
    <div class="container-fluid">
        ...
        <div class="activities1">
            ...
            <div class="form1">
                <p style="font-size: 20px; font-weight: bold;">Price: <span style="font-size: 18px;"><i class="fa-solid fa-peso-sign"></i>100.00</span></p>
                <h6>Pay with?</h6>
                <div class="flex1">
                        <div>
                            <center><img src="../image/gcash.png" alt="" class="rounded" height="100px" width="100px"></center><br>
                            <center><img src="../image/kk.jpg" alt="" height="300px" width="300px" style="border: 2px solid black;" id="cc"></center><br>
                            <center>
                                <form class="gcash" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" id="id" value="<?=$_GET['id']?>">
                                    <input type="hidden" id="u_id" value="<?=$_SESSION['id']?>"><br>
                                    <input type="hidden" id="title" value="<?=$_GET['title']?>"><br>
                                    <label for="amount">Amount</label>
                                    <input type="text" id="amount" class="form-control"><br>
                                    <label for="gcash">Please Upload Your Gcash Screen Shot Receipt</label>
                                    <input type="file" name="gcash" id="gcash" class="form-control"><br>
    ...
    <script src="../js/upload_gcash.js"></script>
