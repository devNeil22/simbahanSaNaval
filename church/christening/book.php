...
<body>
    <div class="container-fluid">
        ...
        <div class="activities1">
            <div class="title"><center><h3>Christening Appointment</h3></center></div>
            <?php
            ...
            <div class="form">
                <form action="" method="post" class="chr-book">
                <?php
                        require_once '../includes/connection.inc.php';
                        $u_id = $_SESSION['id'];
                ...
                <div class="mb-3 mt-3">
                    <input type="hidden" id="title" value="<?=$_GET['t']?>">
                    <label for="Name" class="form-label">Input Full Name of the Baby:</label>
                    <input type="text" name="" id="name" class="form-control" placeholder="Full Name">
                    <span style="color: red" class="error-message"></span>
                </div>
                <div class="mb-3 mt-3">
                    <input type="hidden" id="title" value="<?=$_GET['t']?>">
                    <label for="Name" class="form-label">Upload Scan Birth Certificate:</label>
                    <input type="file" name="" id="b-cert" class="form-control" placeholder="Full Name">
                    <span style="color: red" class="error-message"></span>
                </div>
                 <div class="mb-3 mt-3">
    ...
    <script src="../js/chr-book.js"></script>
