    ...
    <div class="container-fluid">
        <div class="m-nav">
            ...
            <ul class="list">
                ...
                <li><a href="./appointments.php"><i class="fa-solid fa-calendar-days"></i> Appointments</a></li>
        ...
        <div class="activities1">
            <div class="title"><center><h3>Hai User!</h3></center></div>
            
            <div class="form1">
                <p>Thank you for using our platform!</p>
                <p>This is your booking information</p>
                <span><i class="fa-solid fa-calendar-days"></i> March 22, 2020</span><br>
                <span><i class="fa-solid fa-clock"></i> 10:00 AM - 11:00</span><br><br>
                <span>Some information: Neil Bryan Gaviola</span><br><br>
