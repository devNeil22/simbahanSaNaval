...
<body>
    <div class="container-fluid">
        ...
        <div class="activities1">
            ...
            <div class="form1">
                <a href="./donation.php" class="btn btn-primary">My Donation>>>></a><br><br>
                <p><?=$_SESSION['username']?>, you can donate using our gcash account.</p>
                <p>We will send and email as we receive the your donation. Thank you for your donation, God bless your family and love once, God bless and God's Speed!</p>
