<?php
    ...
    if(in_array($filexActualExt, $allowed)){
        ...
        copy( $directory, $copyTo.'/'.$cert);
        $sql = "INSERT INTO christening(priest_id ,date, name, cert, message, u_id, status, year, Month, amount)
            VALUES('$priest_id','$date', '$name', '$cert', '$message', '$id', 0, '$year', '$month', 200)
        ";
