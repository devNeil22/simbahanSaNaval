<?php
    ...
    $id = $_POST['id'];
    $sql = "SELECT * FROM users JOIN holy_mass ON users.u_id = holy_mass.u_id WHERE holy_mass.u_id = $id ORDER BY mass_id DESC";
        ...
        while($data = mysqli_fetch_assoc($execute)){?>
                 <tr>
                    ...
                    <td>
                        ...
                        <a  href="../holy-mass/thankyou.php?id=<?=$data['mass_id']?>" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                        <a href="../holy-mass/pay.php?id=<?=$data['mass_id']?>&title=Holy Mass" class="btn btn-success" data-id="<?=$data['mass_id']?>"><i class="fa-solid fa-money-bill-1-wave"></i></a>
                    </td>
                </tr>
<?php       }
    }
