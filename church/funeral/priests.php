...
<body>
    <div class="container-fluid">
        ...
        <div class="activities1">
            <div class="title"><center><h3>Funeral Mass Reservation</h3></center></div>
            ...
            <div class="flex">
               ...
               <?php
                ...
                while($data = mysqli_fetch_assoc($exe)){ ?>
                    <div id="priests">
                        <a href="./book.php?id=<?=$data['priest_id']?>&title=Funeral Reservation"><img src="../files/<?=$data['profile_pic']?>" alt="" class="rounded"></a>
