...
<body>
    <div class="container-fluid">
        ...
        <div class="activities1">
            <div class="title"><center><h3>Funeral Appointment</h3></center></div>
            <?php
            ...
            ?>
            <center><h4><span>Step 2: </span> Book a Schedule</h4></center>
            <center><h6>Your Choosen Priest: <?=$name['PLast_name'].' '.$name['PFirst_Name']?></h6></center><br>
            <div class="form">
               <form action="" method="post" class="funeral-book">
                <div class="mb-3 mt-3">
                    <?php
                        require_once '../includes/connection.inc.php';
                        $u_id = $_SESSION['id'];
                        ...
                        $name = mysqli_fetch_assoc($execute);
                    ?>
                    <input type="hidden" id="priest_id" value="<?=$_GET['id']?>">
                    ...
                    <input type="text" name="" id="date" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd">
                    <span style="color: red" class="error-message"></span><br>
                    <h6 class="a"></h6>
                </div>
                <div class="time"></div>
                 <div class="mb-3 mt-3">
                ...
                <div class="mb-3 mt-3">
                    <label for="Date" class="form-label">Deceased Name:</label>
                    <input type="text" name="" id="Name" class="form-control" placeholder="Enter Deceased Name">
                    <span style="color: red" class="error-message"></span>
                </div>
                <div class="mb-3 mt-3">
                    <label for="Date" class="form-label">Relationship:</label>
                    <input type="text" name="" id="relationship" class="form-control" placeholder="Enter Deceased Name">
                    <span style="color: red" class="error-message"></span>
                </div>
                <div class="mb-3 mt-3">
                    <label for="Date" class="form-label">Input The Birth Date of the Deceased:</label>
                    <input type="text" name="" id="d-bday" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd">
                    <span style="color: red" class="error-message"></span>
                </div>
                <div class="mb-3 mt-3">
                    <label for="Date" class="form-label">Input the Date HE/SHE DIED:</label>
                    <input type="text" name="" id="d-death" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd">
                    <span style="color: red" class="error-message"></span>
                </div>
                <div class="mb-3 mt-3">
                    <label for="Date" class="form-label">Upload Death Certificate</label>
                    <input type="file" name="" id="certificate"  class="form-control">
                    <span style="color: red" class="error-message"></span>
                </div>
                <div class="mb-3 mt-3">
                    <label for="Date" class="form-label">Upload Deceased Birth Certificate</label>
                    <input type="file" name="" id="b-certificate"  class="form-control">
                    <span style="color: red" class="error-message"></span>
                </div>
    ...
    <script src="../js/funeral-book.js"></script>
