    ...
    <div class="container-fluid">
        ...
        <div class="activities1">
            ...
            <div class="form1">
                ...
                <p>This is your booking information for Wedding Reservation</p>
                ...
                <p>Name of Groom: <span style="font-weight: bold;"><?=$info['groom']?></span></p>
                <p>Name of Bride: <span style="font-weight: bold;"><?=$info['bride']?></span></p>
                
                <p>Your transaction has been recorded!</p>
                <p>Please wait for our call and approval of reservation Thank you!</p>
                <div style="display: flex;">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#d-cert">Groom Certificate</button>
                    <button style="margin-left: 5px;" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#d-birth">Bride Birth Certificate</button>
