  <?php
    ...
    $sql = "SELECT DISTINCT Month FROM christening WHERE year = '$year' ORDER BY c_id DESC";
                ...
                <?php
                    if($num = mysqli_num_rows($exe) > 0){
                        while($month = mysqli_fetch_assoc($exe)){
                            ...
                            $sql1 = "SELECT * FROM christening WHERE Month = '$getNumMonth'";
