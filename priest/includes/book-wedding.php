     ...
     if(in_array($filexActualExt, $allowed)){
        ...
        if(in_array($filexActualExt, $allowed)){
            ...
            if(in_array($filexActualExt, $allowed)){
                ...
                $sql = "INSERT INTO wedding(date, groom, bride, groom_cert, bride_cert, cenomar, u_id, message, status, year, Month)
                VALUES('$date', '$nameGroom', '$nameBride', '$bg_certificate', '$bb_certificate', '$cenomar', '$id', '$message', 0, '$year', '$month')
                ";
