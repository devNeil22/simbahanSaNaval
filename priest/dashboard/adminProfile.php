                    ...
                    <div class="row">
                        <div class="col-md-5 border-right">
                            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                ...
                                <?php  }else{?>
                                    <img class="rounded-circle mt-5" width="150px" src="../files/<?=$get['profile_pic']?>">
                                <?php }
                                ?>
                                <span class="font-weight-bold"><?=$get['username']?></span><span class="text-black-50"><?=$get['email']?></span>
                                            ...
                                            if(mysqli_num_rows($exe)){
                                                while($rows = mysqli_fetch_assoc($exe)){?>
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-md-12"><label class="labels">Username</label><input type="text" class="form-control" placeholder="edit phone number" value="<?=$rows['username']?>" id="username" readonly></div>
                                                    </div>
