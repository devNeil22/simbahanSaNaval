...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="sidebar">
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><a href="./members.php"><i class="fa-solid fa-street-view"></i>  Priest</a></li>
        ...
        <div class="activities1">
            ...
            <table class="table">
                <thead>
                    ...
                    <th scope="col"><a href="./add-priest.php" class="btn btn-primary"><i class="fa-solid fa-plus"></i> Add</a></th>
                    </tr>
                </thead>
                <tbody class="fetch-members">
                </tbody>
        </div>
    ...
    <script src="../js/get-priest.js"></script>
