    ...
    <div class="container-fluid">
        ...
        <div class="member-add">
            <form action="" method="POST" id="add-member">
                ...
                <input type="text" name="last" id="address" placeholder="Address" class="form-control"><br>
                <label for="Last Name">Mobile</label>
                <input type="text" name="last" id="mobile" placeholder="Mobile" class="form-control"><br>
                <div class="mb-3 mt-3">
