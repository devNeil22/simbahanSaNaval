    ...
    <div class="container-fluid">
        ...
        <div class="sidebar">
            <ul class="list-group list-group-flush">
                ...
                <ul class="items">
                        <li class="registered"><i class="fa-solid fa-star"></i> Registered</li>
                        <li class="funeral"><i class="fa-solid fa-star"></i> Funeral</li>
                        <li class="chrs"><i class="fa-solid fa-star"></i> Christening</li>
                        <li class="wedding"><i class="fa-solid fa-star"></i> Wedding</li>
                        <li class="holy"><i class="fa-solid fa-star"></i> Holy Mass</li>
                    </ul>
        ...
        <div id="activities1">
            <h1>Choose From the Menu List in the Sidebar</h1>
        </div>
