        ...
        <br><br><br>
          <div class="sidebar">
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><a href="#"><i class="fa-solid fa-chart-line"></i> Reports</a></li>
            ...
            <?php
                ...
                if(mysqli_num_rows($exe) > 0){
                    while ($info = mysqli_fetch_assoc($exe)) {?>
                        ...
                        <hr>
                        <p style="font-weight: bold;">Reservation ID: <span style="font-weight: 500;"><?=$info['f_id']?></span></p>
                        <hr>
                        <p style="font-weight: bold;">Name: <span style="font-weight: 500;"><?=$info['Last_name']?> <?=$info['First_Name']?></span></p>  
                        <hr>          
                        <p style="font-weight: bold;">Deceased Name: <span style="font-weight: 500;"><?=$info['deacesed_name']?></span></p>  
                        <hr>          
                        <p style="font-weight: bold;">Relationship: <span style="font-weight: 500;"><?=$info['relationship']?></span></p>  
                        <hr>          
                        <p style="font-weight: bold;">Deceased Birthdate: <span style="font-weight: 500;"><?=$info['bday']?></span></p>  
                        <hr>          
                        <p style="font-weight: bold;">Date Died: <span style="font-weight: 500;"><?=$info['death_date']?></span></p>  
                        <hr>          
