<?php
    ...
    if(isset($_POST['search'])){
        ...
        $query = "SELECT * FROM users JOIN wedding ON users.u_id = wedding.u_id WHERE users.First_Name LIKE '{$search}%' OR users.Last_name LIKE '{$search}%'";
            ...
            while($data = mysqli_fetch_assoc($exe)){ ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a  href="../wedding/trans-info.php?id=<?=$data['w_id']?>"" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                         <?php if($data['status'] == 0){?>
                         <button class="confirm btn btn-success" data-id="<?=$data['w_id']?>"><i class="fa-solid fa-thumbs-up"></i></button>
                        <?php }else{ ?>
                            <button class="cancel btn btn-danger" data-id="<?=$data['w_id']?>"><i class="fa-solid fa-ban"></i></button>
                        <?php }?>
                    </td>
                </tr>
        <?php }
