...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-5 border-right">
                            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                    ...
                                    $name = $_GET['id'];
                                    $sql = "SELECT * FROM priests WHERE priest_id = '$name'";
                                    $exe = mysqli_query($connection, $sql);
                                        ...
                                        <?php
                                            ...
                                            if(mysqli_num_rows($exe)){
                                                while($rows = mysqli_fetch_assoc($exe)){?>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-12"><label class="labels">Position</label><input type="text" class="form-control" placeholder="edit phone number" value="<?=$rows['Position']?>" id="position"></div>
    ...
    <script src="../js/editPriest.js"></script>
