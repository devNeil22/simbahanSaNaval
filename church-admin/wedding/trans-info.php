...
<body>
        ...
        <div class="modal" id="d-cert">
            <div class="modal-dialog">
                ...
                <?php
                    ...
                    $id = $_GET['id'];
                    $sql = "SELECT * FROM users JOIN wedding ON users.u_id  = wedding.u_id WHERE w_id = $id";
                    $exe = mysqli_query($connection, $sql);
                    $info = mysqli_fetch_assoc($exe);
                ?>
                <img src="../files/<?=$info['bride_cert']?>" alt="" style="width: 100%; height: 500px; border: 2px solid black">
                </div>
        ...
        <div class="modal" id="d-birth">
            <div class="modal-dialog">
                ...
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Groom's Birth Certificate</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    $info = mysqli_fetch_assoc($exe);
                ?>
                <img src="../files/<?=$info['groom_cert']?>" alt="" style="width: 100%; height: 500px; border: 2px solid black">
                </div>
        ...
        <div class="modal" id="cenomar">
            <div class="modal-dialog">
                <div class="modal-content">

                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Certificate of No Marriage</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    $info = mysqli_fetch_assoc($exe);
                ?>
                <img src="../files/<?=$info['cenomar']?>" alt="" style="width: 100%; height: 500px; border: 2px solid black">
                </div>
                ...
                if(mysqli_num_rows($exe) > 0){
                    while ($info = mysqli_fetch_assoc($exe)) {?>
                        <div style="display: flex;">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#d-cert">Death Certificate</button>
                            <button style="margin-left: 5px;" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#d-birth">Deceased Birth Certificate</button>
                            <button style="margin-left: 5px;" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#cenomar">Cenomar</button>
                        </div>
                        <hr>
                        <p style="font-weight: bold;">Reservation ID: <span style="font-weight: 500;"><?=$info['w_id']?></span></p>
                        <hr>
                        <p style="font-weight: bold;">Name: <span style="font-weight: 500;"><?=$info['Last_name']?> <?=$info['First_Name']?></span></p>  
                        <hr>          
                        <p style="font-weight: bold;">Name of Groom: <span style="font-weight: 500;"><?=$info['groom']?></span></p>  
                        <hr>          
                        <p style="font-weight: bold;">Name of Bride: <span style="font-weight: 500;"><?=$info['bride']?></span></p>  
                        <hr>          
